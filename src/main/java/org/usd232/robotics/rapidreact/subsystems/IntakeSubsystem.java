...
public class IntakeSubsystem extends SubsystemBase {
    ...
    private static final Solenoid leftSolenoid = new Solenoid(PneumaticsModuleType.REVPH, LEFT_PNEUMATIC_PORT);
    private static final Solenoid rightSolenoid = new Solenoid(PneumaticsModuleType.REVPH, RIGHT_PNEUMATIC_PORT);
