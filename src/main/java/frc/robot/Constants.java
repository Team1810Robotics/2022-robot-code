...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int[] REAR_LEFT_DRIVE_ENCODER_PORTS = new int[] {9, 10};
    public static final int[] FRONT_RIGHT_DRIVE_ENCODER_PORTS = new int[] {11, 12};
    public static final int[] REAR_RIGHT_DRIVE_ENCODER_PORTS = new int[] {13, 14};
    ...
    public static final double REAR_LEFT_MODULE_OFFSET = -Math.toRadians(0.0);
    public static final double REAR_RIGHT_MODULE_OFFSET = -Math.toRadians(0.0);
  ...
  public static final class CANCoderConstants {
    ...
    public static final int REAR_LEFT_CAN_CODER = 12;
    public static final int REAR_RIGHT_CAN_CODER = 12;
  }
}
